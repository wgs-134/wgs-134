...
if (StringUtil.isEmpty(Sch_Id)) {
	JOptionPane.showMessageDialog(null, "ʱ����Ų���Ϊ�գ�");
	return;
}

if (StringUtil.isEmpty(Sch_Time)) {
	JOptionPane.showMessageDialog(null, "ʱ���ʱ�䲻��Ϊ�գ�");
	return;
}
...
if (StringUtil.isEmpty(Sch_Free_Id )) {
	JOptionPane.showMessageDialog(null, "����ְҵ�߱�Ų���Ϊ�գ�");
	return;
}
...
try {
	...
	if (n==1) {
		...
		JOptionPane.showMessageDialog(null, "���ʧ�ܣ�ʱ������Ѵ��ڣ�");
	}
